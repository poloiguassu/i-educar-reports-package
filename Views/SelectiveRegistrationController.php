...
require_once 'Reports/Reports/SelectiveRegistrationReport.php';

class SelectiveRegistrationController extends Portabilis_Controller_ReportCoreController
{
    /**
     * @var int
     */
    protected $_processoAp = 21471;
    ...
    /**
     * @return SelectiveRegistrationReport
     *
     * @throws Exception
     */
    public function report()
    {
        return new SelectiveRegistrationReport();
    }
}

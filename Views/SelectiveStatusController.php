...
require_once 'Reports/Reports/SelectiveStatusReport.php';

class SelectiveStatusController extends Portabilis_Controller_ReportCoreController
{
    /**
     * @var int
     */
    protected $_processoAp = 21474;

    /**
     * @var string
     */
    protected $_titulo = 'Situação dos Candidatos do Processo Seletivo';
    ...
    protected function _preRender()
    {
        ...
        $this->breadcrumb(
            'Situação dos Candidatos do Processo Seletivo',
            [
    ...
    /**
     * @return SelectiveStatusReport
     *
     * @throws Exception
     */
    public function report()
    {
        return new SelectiveStatusReport();
    }
}
